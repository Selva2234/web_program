...
public class TraController {
    ...
    public List<Tra> sort(@PathVariable String field) {
        return traService.getTraSort(field);
    }
    
    @GetMapping("/order/{pgn}/{pgs}")
    public List<Tra> getMethodName(@PathVariable int pgn,@PathVariable int pgs) {
        return traService.getOrder(pgn,pgs);
    }
